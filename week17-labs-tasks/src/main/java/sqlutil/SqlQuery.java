...
public class SqlQuery implements AutoCloseable {
    ...
    public SqlQuery(Connection connection, String sql, SqlParam... params) throws SQLException {
        this(connection, sql);
        setParams(params);
    }

    public SqlQuery(Connection connection, boolean autoCommit, String sql, SqlParam... params) throws SQLException {
        this(connection, autoCommit, sql);
        setParams(params);
    }

    public SqlQuery(Connection connection, String sql, int autoGeneratedKeys, SqlParam... params) throws SQLException {
        this(connection, sql, autoGeneratedKeys);
        setParams(params);
    }

    public SqlQuery(Connection connection, boolean autoCommit, String sql, int autoGeneratedKeys, SqlParam... params) throws SQLException {
